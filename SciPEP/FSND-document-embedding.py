...
#link ='https://www.hotnewsheadlines.com/scienece-and-nature/for-the-first-time-astronomers-see-plumes-of-sulfur-dioxide-from-the-volcanoes-of-io-sciencealert/'
#58
...
##########66
#link = 'https://www.sciencealert.com/new-results-from-the-large-hadron-collider-point-to-entirely-new-physics'
#67
...
# 69
#link = 'https://www.sciencealert.com/evidence-of-the-mysterious-odderon-quasiparticle-has-been-found-at-long-last'
# 70
...
# 72
#link ='https://www.sciencealert.com/mysterious-unidentified-circles-have-been-found-in-space'
# 73
...
# 80
#link = 'https://www.scientificamerican.com/article/galaxy-size-gravitational-wave-detector-hints-at-exotic-physics/'
# 81
...
# 83
#link = 'https://www.sciencemag.org/news/2020/05/eye-catching-advances-some-ai-fields-are-not-real'
# 84
...
# 90
#link = 'https://news.mit.edu/2020/shrinking-deep-learning-carbon-footprint-0807'
#91
#link = 'https://www.sciencealert.com/there-could-be-a-whole-bunch-of-high-speed-black-holes-zooming-around-the-galaxy'
#92
#link = 'https://www.sciencealert.com/scientists-set-a-new-record-by-beaming-twisted-light-over-143-km'
#93
...
# 99
#link = 'https://www.sciencealert.com/it-took-4-hours-google-s-ai-world-s-best-chess-player-deepmind-alphazero'
# 100
...
print('\n')
print('Ranking based on Cosine similarity : Doc2Vec ')
...
#print(documents_df)
titles=non_duplicate_titles
titles.insert(0, 'Originan News-article')
documents_df['Titles']=titles
...
def most_similar(doc_id,similarity_matrix,matrix):
    ...
    for ix in similar_ix:
        ...
        print (f'Document: {documents_df.iloc[ix]["Titles"]}')
        print (f'{matrix} : {similarity_matrix[doc_id][ix]}')
        ranks_list[documents_df.iloc[ix]["Titles"]]=similarity_matrix[doc_id][ix]
        pp.append(similarity_matrix[doc_id][ix])
        count=count + 1
    return ranks_list
...
results =most_similar(0,pairwise_similarities,'Cosine Similarity')
